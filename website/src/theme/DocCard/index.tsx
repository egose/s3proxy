...
import { extractLeadingEmoji, useDocCardDescriptionCategoryItemsPlural } from '@docusaurus/theme-common/internal';
...
function getIconTitleProps(item: PropSidebarItemLink | PropSidebarItemCategory): { icon: ReactNode; title: string } {
